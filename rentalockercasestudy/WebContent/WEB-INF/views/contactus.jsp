...
<div class="container">
  <form action="contactusconfirm">
    ...
    <select id="issue" name="issue">
      <option value="Can't Register">Registration Error</option>
      <option value="Can't select a locker">Can't rent Locker</option>
      <option value="Update Profile">Can't Update Profile</option>
